                                ...
                                <form onSubmit={actualizarLote}>
                                    ...
                                    <div className="row mb-3 g-3">
                                        <div className="col-md-4">
                                            <label className="form-label text-white-50 small text-uppercase fw-bold">Clasificación</label>
                                            <select 
                                        ...
                                        <div className="col-md-8">
                                            <label className="form-label text-white-50 small text-uppercase fw-bold">Nombre Especie</label>
                                            <input 
                                                type="text" 
                                    ...
                                    <div className="mb-4">
                                        <label className="form-label text-white-50 small text-uppercase fw-bold">URL de Imagen</label>
                                        <input 
                                            type="text" 
                                            className="form-control bg-transparent text-white border-secondary" 
                                            name="imagen_especie" 
                                    ...
                                    <div className="row mb-4 g-3 align-items-end">
                                        <div className="col-md-3">
                                            <label className="form-label text-white-50 small text-uppercase fw-bold">Kilos Totales</label>
                                            <input 
                                                type="number" 
                                        ...
                                        <div className="col-md-3">
                                            <label className="form-label text-white-50 small text-uppercase fw-bold">Precio Salida ($/Kg)</label>
                                            <input 
                                                type="number" 
                                                className="form-control form-control-lg bg-transparent text-white border-gold" 
                                        ...
                                        <div className="col-md-3">
                                            <label className="form-label text-white-50 small text-uppercase fw-bold">Tipo de Envase</label>
                                            <select 
                                        ...
                                        <div className="col-md-3">
                                            <label className="form-label text-gold small text-uppercase fw-bold">Cajas (Auto)</label>
                                            <input 
                                                type="text" 
                                    ...
                                    <div className="p-3 rounded mb-4" style={{background: 'rgba(255,255,255,0.05)', border: '1px solid var(--oro-oscuro)'}}>
                                        <div className="row text-center align-items-center">
                                            <div className="col-4">
                                                <small className="text-white-50 d-block text-uppercase" style={{fontSize: '0.7rem'}}>Valor Pescado</small>
                                                <span className="fw-bold fs-5 text-white">${(lote.kilos * lote.precio_kilo_salida || 0).toFixed(2)}</span>
                                            </div>
                                            <div className="col-4 border-start border-end border-secondary">
                                                <small className="text-white-50 d-block text-uppercase" style={{fontSize: '0.7rem'}}>Costo Cajas</small>
                                                <span className="fw-bold fs-5 text-danger">+ ${lote.costo_cajas_total}</span>
                                            </div>
                                            <div className="col-4">
                                                <small className="text-gold d-block text-uppercase fw-bold" style={{fontSize: '0.7rem'}}>Valor Total Lote</small>
                                                <span className="fw-bold fs-4 text-gold">${lote.valor_total_lote}</span>
                                            </div>
                                        </div>
                                    </div>
