...
const CompraPescadoSemigraso = () => {
  ...
  const buscarCliente = async () => {
    ...
    try {
      ...
      // Si la API no lo encuentra (aunque esto debería ser manejado por el catch con 404):
    ...
    >
      <div
        style={{
          ...
          height: "100%",
          zIndex: 0,
          backgroundImage: `linear-gradient(to right, rgba(2, 30, 38, 0.95), rgba(2, 30, 38, 0.85) 40%, rgba(2, 30, 38, 0.4) 100%), url("${imagenFondo}")`,
                ...
                <form onSubmit={procesarVenta}>
                  <div className="mb-5">
                    ...
                    <select
                      ...
                      required
                    >
                      <option value="">-- Catálogo de Pescado Semigraso --</option>
                      {inventario.map((lote) => (
          ...
          <div className="row justify-content-center mb-5">
            <div className="col-lg-8">
              ...
              <p className="lead text-white-50 fs-5">
                Conocidos por su versatilidad y calidad superior. Especies como
                el Besugo y la Dorada que aportan una textura firme y un sabor
                delicado a cualquier preparación.
              </p>
            </div>
          </div>
        </div>
