                                        ...
                                        <div className="animate__animated animate__fadeIn">
                                            ...
                                            <div className="p-4 rounded mb-4" style={{background: 'rgba(255,255,255,0.05)', border: '1px solid var(--oro-oscuro)'}}>
                                                <div className="d-flex justify-content-between align-items-center">
                                                    <span className="text-gold fw-bold fs-5">TOTAL A PAGAR</span>
                                                    <span className="display-5 fw-bold text-white" style={{textShadow: '0 0 15px rgba(212, 175, 55, 0.5)'}}>${compra.gran_total}</span>
                                                </div>
                                                <div className="text-end text-white-50 small mt-1">Incluye costo de {compra.cajas} cajas</div>
                                            </div>
