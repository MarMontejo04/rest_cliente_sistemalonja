          ...
          <div className="row justify-content-center mb-5">
            <div className="col-lg-8">
              ...
              <p className="lead text-white-50 fs-5">
                Capturados diariamente en las costas de Veracruz, nuestros
                mariscos y crustáceos representan la frescura y calidad que nos
                distingue. Seleccionados cuidadosamente para garantizar el mejor
                sabor en cada platillo.
              </p>
            </div>
          </div>
        </div>
