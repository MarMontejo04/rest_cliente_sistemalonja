                    ...
                    <div className="col-lg-5 mb-5 mb-lg-0 text-white animate__animated animate__fadeInLeft">
                        ...
                        {compra.id_lote ? (
                            ...
                            <div>
                                ...
                                <p className="lead text-white-50 fs-4">Alta calidad en pescados azules, ricos en Omega-3.</p>
                            </div>
                        )}
                    </div>
                ...
                <div className="container text-center">
                    <div className="row justify-content-center mb-5">
                        <div className="col-lg-8">
                            <h2 className="text-gold mb-3 display-4" style={{fontFamily: "'Cinzel', serif"}}>Pescado Azul</h2>
                            ...
                            <p className="lead text-white-50 fs-5">
                                Especies ricas en grasas saludables y sabor intenso. La mejor opción para parrilladas y platillos con carácter.
                            </p>
                        </div>
                    </div>
                </div>
