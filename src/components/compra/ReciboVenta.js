...
const ReciboVenta = () => {
    ...
    const datosRecibidos = location.state; // Recibimos los datos del formulario anterior

    // Construimos el objeto de venta con datos reales o simulados si se entra directo
    const venta = datosRecibidos ? {
        folio: datosRecibidos.folio,
        fecha: new Date().toLocaleDateString(),
        hora: new Date().toLocaleTimeString([], { hour: '2-digit', minute: '2-digit' }),
        cliente: `${datosRecibidos.datosVenta.nombre_cliente} ${datosRecibidos.datosVenta.apellido_paterno}`,
        producto: `${datosRecibidos.datosVenta.especieNombre} (${datosRecibidos.datosVenta.especieTipo})`,
        peso: `${datosRecibidos.datosVenta.kilos} kg`,
        cajas: datosRecibidos.datosVenta.cajas,
        total: parseFloat(datosRecibidos.datosVenta.gran_total)
    } : {
        // Datos de respaldo por si se recarga la página sin estado
        folio: id || 'V-ERR-00',
        fecha: new Date().toLocaleDateString(),
        hora: '--:--',
        ...
        <div className="container-fluid p-0 d-flex align-items-center justify-content-center bg-animated" style={{minHeight: '100vh'}}>
            ...
            <div className="container py-4">
                <div className="row justify-content-center align-items-center">
                    ...
                    {/* COLUMNA DEL RECIBO (Ticket Blanco) */}
                    <div className="col-md-6 col-lg-5 mb-4 mb-md-0">
                        <div className="card border-0 shadow-lg" style={{backgroundColor: '#FFF', color: '#000', borderRadius: '0'}}>
                            ...
                            <div className="card-header bg-white border-bottom-0 pt-4 pb-0 text-center">
                                <h2 className="mb-0 text-uppercase h4" style={{fontFamily: "'Cinzel', serif", color: 'var(--color-panel)', letterSpacing: '1px'}}>
                                    Lonja Veracruz
                                </h2>
                            ...
                            <div className="card-body px-4 pb-4">
                                ...
                                <div className="small">
                                    ...
                                    <div className="row mb-1">
                                        ...
                                        <div className="col-6 text-end fw-bold text-truncate">{venta.cliente}</div>
                                    </div>
                                ...
                                <div className="alert alert-warning d-flex align-items-start mb-0 p-2" role="alert" style={{fontSize: '0.75rem', border: '1px solid #ffecb5', backgroundColor: '#fff3cd', color: '#664d03'}}>
                                    ...
                                    <div>
                                        <strong>IMPORTANTE:</strong> Conserve este ticket. Es necesario presentarlo en caja para realizar el pago y retirar su mercancía.
                                    </div>
                                </div>
                            </div>
                            
                            {/* Decoración dentada al final del ticket */}
                            <div style={{
                                height: '15px', 
                    ...
                    {/* COLUMNA DE ACCIONES (Botones laterales) */}
                    <div className="col-md-5 col-lg-4 ps-md-5">
                        <div className="d-flex flex-column gap-3">
                            ...
                            {/* Este enlace regresa al inicio para elegir otro tipo de pescado */}
                            ...
                            <Link to="/compras/reporte" className="btn btn-outline-warning btn-lg w-100 py-3 text-start d-flex align-items-center justify-content-between hover-scale text-decoration-none">
                                <span><i className="fas fa-chart-line me-3"></i>Ver Reporte del Día</span>
                                <i className="fas fa-chevron-right small"></i>
                            </Link>
