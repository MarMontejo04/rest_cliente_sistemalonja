...
const Login = () => {
    ...
    const iniciarSesion = async (e) => {
        ...
        try {
            ...
            localStorage.setItem('rol', usuario ? usuario.rol : 'vendedor'); 
            ...
            Swal.fire({
                ...
                text: error.response?.data?.mensaje || 'Hubo un error al conectar con el servidor',
                confirmButtonColor: 'var(--oro-principal)',
                background: '#042B35',
                color: '#F0F0F0'
            });
                    ...
                    <div className="col-md-8 col-lg-5">
                        <div className="card-premium shadow-lg border-gold p-5" style={{background: 'rgba(4, 43, 53, 0.95)'}}>
                            <div className="text-center mb-5">
                                ...
                                <h2 className="text-white mb-1" style={{fontFamily: "'Cinzel', serif", letterSpacing: '2px'}}>ACCESO SISTEMA</h2>
                            ...
                            <form onSubmit={iniciarSesion}>
                                <div className="mb-4">
                                    ...
                                    <div className="input-group">
                                        ...
                                        <input type="email" className="form-control bg-transparent text-white border-gold" style={{height: '50px'}} name="correo" placeholder="usuario@lonja.com" onChange={leerDatos} autoComplete="off"/>
                                    </div>
                                </div>
                                <div className="mb-5">
                                    ...
                                    <div className="input-group">
                                        ...
                                        <input type="password" className="form-control bg-transparent text-white border-gold" style={{height: '50px'}} name="password" placeholder="••••••••" onChange={leerDatos}/>
                                    </div>
                                </div>
                                <button type="submit" className="btn-premium w-100 py-3 fs-5 fw-bold shadow-lg letter-spacing-1">INGRESAR</button>
                            </form>
                            <div className="text-center mt-4 pt-3 border-top border-secondary">
                                <a href="/" className="text-white-50 text-decoration-none small hover-gold transition"><i className="fas fa-arrow-left me-2"></i> Volver al Inicio</a>
                            </div>
                        </div>
                    </div>
                </div>
